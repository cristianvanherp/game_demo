...
public class Stage extends Canvas implements Runnable, InputSensible {
	...
	public Stage(double FPS, double TPS, double APS, int gravity, int maxFallingSpeed) {
		...
		this.entity = new Entity(32, 32, 100, 100, 3, "/spritesheet_1_player.png", 4, 3, true, 17);
		this.gameObjects = new ArrayList<GameObject>();
		this.gameObjects.add(this.entity);
		
		this.gameObjects.add(new Block(40, 40, 182, 177, 5, "/block_grass_1.png", 1, 1, true, 10));
		this.gameObjects.add(new Block(40, 40, 141, 217, 5, "/block_grass_1.png", 1, 1, true, 10));
		this.gameObjects.add(new Block(40, 40, 100, 7, 5, "/block_grass_1.png", 1, 1, true, 10));
		this.gameObjects.add(new Block(40, 40, 100, 318, 5, "/block_grass_1.png", 1, 1, false, 10));
		this.gameObjects.add(new Block(40, 40, 100, 359, 5, "/block_grass_1.png", 1, 1, false, 10));
		this.gameObjects.add(new Block(40, 40, 100, 400, 5, "/block_grass_1.png", 1, 1, false, 10));
		this.gameObjects.add(new Block(40, 40, 141, 400, 5, "/block_grass_1.png", 1, 1, false, 10));
		this.gameObjects.add(new Block(40, 40, 182, 400, 5, "/block_grass_1.png", 1, 1, false, 10));
		this.gameObjects.add(new Block(40, 40, 223, 400, 5, "/block_grass_1.png", 1, 1, false, 10));
		this.gameObjects.add(new Block(40, 40, 264, 400, 5, "/block_grass_1.png", 1, 1, false, 10));
		this.gameObjects.add(new Block(40, 40, 305, 400, 5, "/block_grass_1.png", 1, 1, false, 10));
		this.gameObjects.add(new Block(40, 40, 346, 400, 5, "/block_grass_1.png", 1, 1, false, 10));
		this.gameObjects.add(new Block(40, 40, 387, 400, 5, "/block_grass_1.png", 1, 1, false, 10));
		this.gameObjects.add(new Block(40, 40, 428, 400, 5, "/block_grass_1.png", 1, 1, false, 10));
		this.gameObjects.add(new Block(40, 40, 469, 400, 5, "/block_grass_1.png", 1, 1, false, 10));
