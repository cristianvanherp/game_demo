...
public class Stage extends Space {
	...
	public Stage(double FPS, double TPS, double APS, String backgroundPath, int gravity, int maxFallingSpeed) {
		...
		this.getMap().getGameObjects().add(this.entity);
		...
		this.getMap().getGameObjects().add(new Block(40, 40, 100, 7, 5, new SpriteSheet("/block_grass_1.png", 1, 1, 40, 40, 0, 0, 0, 0), false, 10));
